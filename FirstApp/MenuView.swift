...
struct MenuView: View {
    var body: some View {
        VStack {
            ...
            VStack(spacing: 16) {
                Text("Sannan - 28% complete").font(.caption)
                ...
                MenuRow(title: "Billing", icon: "person.crop.circle")
            }
    ...
    var body: some View {
        HStack(spacing: 16) {
            Image(systemName: self.icon)
                ...
                .foregroundColor(Color(#colorLiteral(red: 0.2530170395, green: 0.5856890446, blue: 0.8177306962, alpha: 1)))
