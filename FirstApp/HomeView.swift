...
struct HomeView: View {
    ...
    @State var showUpate: Bool = false
    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Button(action: {self.showUpate.toggle()}) {
                ...
                .sheet(isPresented: self.$showUpate) {
                    ContentView()
                }
            }
            .padding(.horizontal)
...
let sectionDate = [
    ...
    Section(title: "Introduction to Computer Networks", text: "12 Sections", logo: "Logo1", image: Image("Card2"), color: Color("card3")),
    Section(title: "Basics of Human Computer Interaction", text: "20 Sections", logo: "Logo1", image: Image("Card4"), color: Color("card4"))
]
